...
from vpython import *
#math es una librería de matemáticas
import math
#numpy es una librería de matemáticas
import numpy as np
...
def f(vx,vy,inicio):
    ...
    while True:
        ...
        tiempo+=1
        #Condición de finalización del while.
        if(tiempo==100000):
            break
    ...
    if(posiciones[0]<mag(distOriginal):
        print(vx,vy,inicio,mag(Ship.pos-Mars.pos))
        return posiciones[0]
    print(vx,vy,inicio,mag(Ship.pos-Mars.pos))
...
f(-4.232908947857807, 6.565088334167799, 29406)
